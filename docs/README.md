...
| Guide | Description |
|-------|-------------|
| [getting-started.md](getting-started.md) | Clone, prerequisites, create an app, install & run |
...
| [experiments/](experiments/) | Agent-written research notes (experiment-agent) |
